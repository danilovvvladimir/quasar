export const BASE_LAYOUT_METADATA_TITLE: string = "QUASAR |";
...
export const NOTFOUNDPAGE_METADATA_DESCRIPTION: string =
  "Quasar страница не найдена";
export const WISHLIST_PAGE_METADATA_TITLE: string = "QUASAR | Избранное";
export const WISHLIST_PAGE_METADATA_DESCRIPTION: string = "Quasar Избранное";
export const PROFILE_PAGE_REVIEWS_METADATA_TITLE: string = "QUASAR | Отзывы";
export const PROFILE_PAGE_REVIEWS_METADATA_DESCRIPTION: string =
  "Quasar Отзывы";
export const PROFILE_PAGE_ORDERS_METADATA_TITLE: string = "QUASAR | Заказы";
